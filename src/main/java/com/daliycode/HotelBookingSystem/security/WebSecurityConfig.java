...
//
//
//import com.daliycode.HotelBookingSystem.security.jwt.AuthTokenFilter;
//import com.daliycode.HotelBookingSystem.security.jwt.JwtAuthEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, UrlBasedCorsConfigurationSource corsConfigurationSource) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/bookings/confirmation/**").permitAll() // 新增
                        .requestMatchers("/bookings/room/{roomId}/booking").permitAll()
